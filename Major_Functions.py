...
def read (library):
    ...
    old_pages = library[choose - 1]['book pages'].split('/')[0]
    total_pages = library[choose - 1]['book pages'].split('/')[1]
    library[choose - 1]["book pages"] = f"{old_pages+readpages} / {total_pages}"
    clac_percentage(library, choose)
